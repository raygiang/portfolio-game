namespace Game {
  export let playerBehaviour: PlayerBehaviour;
  export let cameraBehaviour: CameraBehaviour;
  ...
  export function initScene(sceneName: string) {
    ...
    if (currentScene != null) {
      ...
      playerActor.setLocalEulerAngles(0, spawnActor.getLocalEulerAngles().y + Math.PI, 0);
    }
    ...
    //   .onComplete(function() { playerActor.getBehavior(PlayerBehaviour).canMove = true; })
    //   .start();
  }
}
